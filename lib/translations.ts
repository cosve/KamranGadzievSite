...
export const translations = {
  ru: {
    meta: {
      title: "Кямран Гаджиев — азербайджанский ведущий и тамада меджлисов",
      description:
    ...
    pages: {
      wedding: {
        ...
        metaTitle:
          "Ведущий на азербайджанскую свадьбу и меджлис — Кямран Гаджиев",
        description:
          "Кямран Гаджиев — профессиональный ведущий на азербайджанскую свадьбу и свадебный меджлис. Тамада азербайджанец с опытом работы по всей России и в Азербайджане.",
        paragraphs: [
          "Свадебный меджлис — важнейшее торжество в жизни азербайджанской семьи. Кямран Гаджиев — профессиональный ведущий на азербайджанскую свадьбу, который сохраняет традиции меджлиса и создаёт атмосферу тепла, уважения и радости для всех гостей.",
          "Тамада на азербайджанскую свадьбу — ключевая фигура любого меджлиса. Как азербайджанский ведущий, Кямран ведёт торжество на двух языках — азербайджанском и русском, управляет ходом вечера и чтит национальные обряды.",
          "Азербайджанские свадьбы известны своим масштабом, большим количеством гостей и насыщенной программой. Кямран Гаджиев проводит свадебные меджлисы по всей России — в Москве, Санкт-Петербурге и других городах, а также в Азербайджане.",
          "Выбирая ведущего на свадебный меджлис, важны опыт, знание культурных традиций и свободное владение языком. Именно это делает Кямрана Гаджиева идеальным тамадой азербайджанцем для вашего торжества.",
        ],
      },
      anniversary: {
        title: "Юбилей и день рождения",
        metaTitle:
          "Ведущий на азербайджанский юбилей и день рождения — Кямран Гаджиев",
        description:
          "Кямран Гаджиев — ведущий на азербайджанский юбилей и день рождения. Профессиональный тамада азербайджанец для праздников по всей России и Азербайджану.",
        paragraphs: [
          "Азербайджанский юбилей и день рождения — торжества, на которых важна культура. Кямран Гаджиев — ведущий азербайджанец, специализирующийся на юбилеях и днях рождения с сохранением национального духа и традиций.",
          "Профессиональный ведущий на азербайджанский юбилей строит сценарий под конкретную семью, вовлекает гостей, поддерживает настроение и соблюдает культурный этикет. Тамада на азербайджанский день рождения — это не декорация, а душа праздника.",
          "С профессиональным тамадой азербайджанцем день рождения или юбилей проходит легко, без пауз и неловких моментов. Кямран берёт на себя полную организацию хода мероприятия — от первого тоста до финала вечера.",
          "Кямран Гаджиев проводит юбилеи и дни рождения в Москве, Санкт-Петербурге, других городах России и в Баку. Учитывает пожелания семьи, количество гостей и культурные особенности каждого торжества.",
          "Ведущий азербайджанец на вашем юбилее — это вклад в атмосферу, эмоции и воспоминания, которые останутся у ваших гостей на долгие годы.",
        ],
      },
      events: {
        title: "Мероприятие",
        metaTitle: "Ведущий на азербайджанское мероприятие — Кямран Гаджиев",
        description:
          "Кямран Гаджиев — азербайджанский ведущий мероприятий. Корпоративы, торжества, меджлисы по всей России и Азербайджану. Профессиональный тамада азербайджанец.",
        quote:
          "Каждое мероприятие — это индивидуальный сценарий, продуманный до мелочей.",
        paragraphs: [
          "Азербайджанское мероприятие требует ведущего, который понимает культуру изнутри. Кямран Гаджиев — профессиональный азербайджанский ведущий с опытом проведения торжеств любого формата по всей России и Азербайджану.",
          "Главная задача ведущего мероприятий — не просто говорить, а создавать живой контакт с аудиторией. Кямран уделяет особое внимание вовлечённости гостей, уважительному общению и соблюдению азербайджанских традиций на каждом этапе вечера.",
          "Ищете ведущего на азербайджанское мероприятие в Москве, Санкт-Петербурге или Баку? Свяжитесь с Кямраном Гаджиевым — тамадой азербайджанцем, который сделает ваш праздник по-настоящему незабываемым.",
        ],
      },
    },
    privacyPage: {
  ...
  az: {
    meta: {
      title: "Kamran Hacıyev — məclis aparıcısı, toy və tədbirlər üzrə tamada",
      description:
        "Kamran Hacıyev — peşəkar Azərbaycan məclis aparıcısı və tamada. Toy, yubiley, ad günü — Rusiya və Azərbaycanda.",
    },
    common: {
      home: "Ana səhifə",
      wedding: "Toy",
    ...
    home: {
      ...
      heroLead: "Elit tədbirlərin memarı.",
      heroLeadAccent: "Məclis aparıcısı.",
    ...
    pages: {
      wedding: {
        title: "Toy məclisi",
        metaTitle: "Azərbaycan toyu üçün aparıcı və tamada — Kamran Hacıyev",
        description:
          "Kamran Hacıyev — Azərbaycan toyu və məclisi üçün peşəkar aparıcı. Rusiya və Azərbaycanda toy tamadası.",
        paragraphs: [
      ...
      anniversary: {
        ...
        metaTitle:
          "Yubiley və ad günü üçün aparıcı — Kamran Hacıyev",
        description:
          "Kamran Hacıyev — yubiley və ad günü üçün peşəkar Azərbaycan aparıcısı. Rusiya və Azərbaycanda tamada xidməti.",
        paragraphs: [
      ...
      events: {
        title: "Tədbir",
        metaTitle: "Azərbaycan tədbirləri üçün aparıcı — Kamran Hacıyev",
        description:
          "Kamran Hacıyev — peşəkar Azərbaycan tədbir aparıcısı. Rusiya və Azərbaycanda hər növ mərasim üçün tamada.",
        quote:
  ...
  en: {
    meta: {
      title: "Kamran Gadzhiev — Azerbaijani event host and majlis MC",
      description:
        "Kamran Gadzhiev — professional Azerbaijani event host and tamada. Weddings, majlis, anniversaries and birthdays across Russia and Azerbaijan.",
    },
    common: {
      home: "Home",
      wedding: "Wedding",
    ...
    home: {
      heroTitle: "Kamran Gadzhiev. Poet.",
      heroLead: "Architect of elite events.",
      heroLeadAccent: "Majlis host.",
    ...
    pages: {
      wedding: {
        ...
        metaTitle:
          "Azerbaijani wedding host and majlis MC — Kamran Gadzhiev",
        description:
          "Kamran Gadzhiev — professional host for an Azerbaijani wedding and majlis. Tamada with experience across Russia and Azerbaijan.",
        paragraphs: [
      ...
      anniversary: {
        ...
        metaTitle:
          "Azerbaijani anniversary and birthday host — Kamran Gadzhiev",
        description:
          "Kamran Gadzhiev — professional Azerbaijani host for anniversaries and birthdays across Russia and Azerbaijan.",
        paragraphs: [
      ...
      events: {
        title: "Event",
        metaTitle: "Azerbaijani event host and tamada — Kamran Gadzhiev",
        description:
          "Kamran Gadzhiev — professional Azerbaijani event host and tamada for any occasion across Russia and Azerbaijan.",
        quote:
